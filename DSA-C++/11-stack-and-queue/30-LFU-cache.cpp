...
// LFUCache(int capacity): Initilize the object with the capacity of the data structure.
// int get(int key): Return value of the key if the key exists in the cache. Otherwise, returns -1.
